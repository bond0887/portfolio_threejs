...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send('service_imafvto', 'template_bbnbup8', {
      from_name: form.name,
      to_name: 'Suraj',
      from_email: form.email,
      to_email: 'jindalsuraj45@gmail.com',
    ...
    <div className='xl:mt-12 xl:flex-row flex-col-reverse flex gap-10 overflow-hidden'>
      ...
      >
        ...
        >
          ...
          <button
            type='submit'
            className='bg-tertiary py-3 px-8 outline-none w-fit teext-white font-bold shadow-md shadow-primary rounded-xl'
          >
